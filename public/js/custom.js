...
$('.clean-solutions-Slider').on('afterChange', function(event, slick, currentSlide) {
...
$('.slider-nav').on('click', '.slick-slide', function(event) {
  ...
  $('.clean-solutions-Slider').slick('slickGoTo', goToSingleSlide);
});
