...
<div class="task-date-popup">
  <div class="modal fade" id="yes_complete" aria-hidden="true" aria-labelledby="taskDateLabel" tabindex="-1">
          ...
          <div class="interested-provider-chat-right">
            <div class="chat-review-warp chat-box-list">
              ...
              <div class="review-box pay_review">
                ...
                <a class="link-text home-cleaning-text" href="#">Home Cleaning</a>
                ...
                <input type="text" name="starrating" id="rating" value="">
                <input type="text" name="provider_id" value="{{$_GET['provider_id']}}">
                <input type="text" name="user_id" value="{{Auth::user()->id}}">
                <input type="text" name="task_id" value="{{$_GET['task_id']}}">
                <p>Would you hire again: <span>Yes</span></p>

                <p>Will You recommend to a loved one?: <span>Yes</span></p>

                <p class="review-by">Review by: <span>Praveen Solanki</span></p>

                <p class="review-helpful">Was this review helpful? <i class="fa-solid fa-heart"></i></p>
  
                <h5 class="review-heading">Comment</h5>
                
                  <textarea placeholder="Write your comment here" name="user_review_com"></textarea>
