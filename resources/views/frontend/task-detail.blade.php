...
<main id="main" class="bg-color-gray">
  @if(session()->has('taskcreat'))
  <div class="alert alert-success" style="text-align: center;">
    {{ session()->get('taskcreat') }}
  </div>
  @endif
  <section class="business-detail task-detail-sec">
    <div class="container">
      <form id="stepForm" method="POST" action="/insert-task" enctype="multipart/form-data">
        @csrf
        <div class="main_wrap">
          <div class="bus-det-left active">
            <div class="close-btn">
              <a data-bs-toggle="modal" href="#close_task" role="button" data-bs-dismiss="modal">
            ...
            <div class="wrap_bg task-detail">
              <div class="check-box-listMain">
                ...
                <select name="cleaning_radio" id="cleaning_radio" class="cleaning_radio js-example-templating form-control form-select" style="border: 1.3px solid #D4D4D8!important;">
                  ...
                  @foreach($select_category as $select_cat)
              ...
              <hr>
              @foreach($select_questions as $select_que)
              @php
              if($select_que->field_value)
              {
                $texts = explode(',',$select_que->field_value);
              }
              @endphp
              @if($select_que->database_field_type == 'text')
              <div class="check-box-listMain">
                <div class="form-field mb-0">
                  <label>{{$select_que->question}}</label>
                </div>
                <div>
                  <input type="{{$select_que->database_field_type}}" name="{{$select_que->field_name}}" id="{{$select_que->field_name}}" 
                    class=" form-control">
                </div>
              </div>
              <hr>
              @elseif($select_que->database_field_type == 'number')
              <div class="check-box-listMain">
                <div class="form-field mb-0">
                  <label>{{$select_que->question}}</label>
                </div>
                <div class="increment-qty">
                  ...
                  <input type="text" name="{{$select_que->field_name}}" id="{{$select_que->field_name}}" class="qty form-control" maxlength="12" value="3"
              ...
              <hr>
              @elseif($select_que->database_field_type == 'redio')
              <div class="check-box-listMain">
                <div class="form-field mb-0">
                  <label>{{$select_que->question}}</label>
                </div>
                ...
                <div class="check-box-radius">
                  <label>
                    <input type="radio" name="{{$select_que->field_name}}" id="{{$select_que->field_name}}" value="{{$tex}}" >
                    <span></span>
                      {{$tex}}
                  </label>
                </div>
              ...
              @elseif($select_que->database_field_type == 'checkbox')
              <div class="check-box-listMain">
                <div class="form-field mb-0">
                  <label>{{$select_que->question}}</label>
                </div>
                ...
                <div class="check-box-radius check-box-radius-forPX">
                  <label>
                    <input type="checkbox" name="{{$select_que->field_name}}[]" id="{{$select_que->field_name}}" value="{{$tex}}">
                    ...
                    <div class="upload__img-wrap">
                      <div class="upload__btn-box">
                        <label class="upload__btn upload-box-bg">
                            ...
                            <svg viewBox="0 0 31 31">
                              <g id="Group_54735" data-name="Group 54735" transform="translate(-518.292 -314.292)">
                                <circle id="Ellipse_676" data-name="Ellipse 676" cx="14.5" cy="14.5" r="14.5"
                                  transform="translate(519.292 315.292)" fill="none" stroke="#47bbd0" stroke-linecap="round" stroke-width="2" />
                          ...
                          <input type="file" multiple="" data-max_length="20" name="task_image[]" id="task_image" class="upload__inputfile">
                        </label>
                      </div>
                    </div>
                  </div>
          ...
          <fieldset id="describe">
            ...
            <div class="wrap_bg task-detail">
              ...
              <textarea class="form-control" name="task_des" id="task_des" placeholder="Hi! Looking for help updating my 650 sq ft apartment. I’m on the 2nd floor up a
                short flight of stairs. Please bring an electric drill and ring doorbell number 3. Thanks!"></textarea>
                          ...
                          <svg width="16.227" height="19.5" viewBox="0 0 16.227 19.5">
                            <g id="Icon_feather-map-pin" data-name="Icon feather-map-pin" transform="translate(-3.75 -0.75)">
                              <path id="Path_24078" data-name="Path 24078"
                                d="M19.227,8.864c0,5.727-7.364,10.636-7.364,10.636S4.5,14.591,4.5,8.864a7.364,7.364,0,1,1,14.727,0Z" transform="translate(0 0)" fill="none" stroke="#47bbd0" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                              <path id="Path_24079" data-name="Path 24079"
                                d="M18.409,12.955A2.455,2.455,0,1,1,15.955,10.5a2.455,2.455,0,0,1,2.455,2.455Z"
                                transform="translate(-4.091 -4.091)" fill="none" stroke="#47bbd0" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                              </g>
                          </svg>
                        </div>

                        <input type="text" name="task_address" value="{{old('task_address')}}" id="task_address" class="form-control" placeholder="Caribbean Blvd, Cutler Bay, FL, USA">
          ...
          <fieldset id="budget" >
            ...
            <div class="wrap_bg task-detail">
              ...
              <div class="budget-price">
                ...
                <input type="text" name="task_budget" id="task_budget" class="form-control" placeholder="1500.00">
              </div>
              <div class="budget-bottom">
                <div class="late_check">
                  <div class="checkBox checkBox-liheight">
                    <label for="know"><input type="checkbox" value="I don't know" name="know" id="know"><span></span>I don't know</label>
                  </div>
                </div>
              </div>
              <hr>
              <div class="check-box-listMain">
                ...
                <div class="check-box-radius">
                  <label>
                    <input type="radio" name="financing" value="Yes, I am interested" checked>
                    <span></span>
                      Yes, I am interested
                  </label>
                </div>
                <div class="check-box-radius">
                  <label>
                    <input type="radio" name="financing" value="No, Not interested">
                    <span></span>
                    No, Not interested
                  </label>
                </div>
                ...
                <div class="provider-listing-box">
                  <div class="check-box-radius col_open">
                    ...
                    <div id="has_hour" class="hours_list" style="display: none;">
                      <input class="form-control current-date" type="text" name="datetimes" id="datetimes">
                    </div>
                  </div>
                  <div class="check-box-radius check-box-radius-forPX">
                    <label>
                      <input type="radio" name="shipping" id="shipping" value="Morning (8am - 12pm)">
                      <span><i class="check-icon"></i></span>
                      Morning (8am - 12pm)
                    </label>
                  </div>
                  <div class="check-box-radius check-box-radius-forPX">
                    <label>
                      <input type="radio" name="shipping" id="shipping" value="Afternoon (12pm - 5pm)">
                      <span><i class="check-icon"></i></span> 
                      Afternoon (12pm - 5pm)
                  ...
                  <div class="check-box-radius check-box-radius-forPX">
                    <label>
                      <input type="radio" name="shipping" id="shipping" value="Evening (5pm - 9:30pm)">
                      <span><i class="check-icon"></i></span>
                      Evening (5pm - 9:30pm)
                    </label>
                  </div>
                  <div class="check-box-radius check-box-radius-forPX">
                    <label>
                      <input type="radio" name="shipping" id="shipping" value="I'm flexible">
                      <span><i class="check-icon"></i></span>
                      I'm flexible
                    </label>
                  </div>
  ...
  <div class="upgrade-membership-popup">
    <div class="modal fade" id="close_task" aria-hidden="true" aria-labelledby="Cancel-job1Label"
      tabindex="-1">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="ceate-listing-content modal-content-padd">
            ...
            <p><span>Are you sure you want to leave?</span><br>
            <span style="margin-top: 10px;">We are just asking some questions to ensure we get the right service provider for you.</span></p> 
 
            <div class="create-btn">
              <input type="hidden" name="" id="credit_id_data">
              <!-- <button type="button" class="btn" id="redirect_provider">Yes</button> -->
              <a class="btn btn-bg-red" href="/" role="button">Yes</a>
...
<!-- <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
 -->
 <script src="{{asset('js/validate-1.7.js')}}"></script>
...
<script>
  $(document).ready(function() {
        $('#know:checkbox').change(function(){
    if($(this).is(":checked")) {
        $('#task_budget').attr('readonly', true);
    } else {
        $('#task_budget').removeAttr('readonly', true);
    }
});
    });
</script>
...
<!--Script for get cleaning ration value -->
<script>
    $(document).ready(function(){
        ...
        $("#hi").addClass("intro");
          ...
          window.location.href = "{{url('task-details')}}" + "?name=" + radioValue;
...
<!--End script for get cleaning ration value -->
