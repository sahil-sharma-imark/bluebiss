...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="../assets/" data-template="vertical-menu-template-free" >
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('admin/img/images/logo.png')}}" />
  ...
  <body>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <x-dropdown-link :href="route('logout')" onclick="event.preventDefault(); this.closest('form').submit();" onclick="event.preventDefault();
    ...
    <!-- Page JS -->
    <script src="{{asset('admin/dashboards-analytics.js')}}"></script>
