      ...
      <div class="container">
        ...
        <div class="profile_middle">
          <div class="profile_detail">
            <div class="profile">
              <figure>
                <img src="{{asset('uploads/provider/'.$providerid.'/business_profile/'.$pro_profile->image)}}" alt="profile">
              </figure>
              <div class="ctnt">
                ...
                <div class="badge_ctnt">
                  ...
                  <ul>
                    <li>
                      ...
                      @php
                      $identity_document = json_decode($pro_profile->identity_document, true);
                      $address_proof = json_decode($pro_profile->address_proof, true);
                      $bus_registration = json_decode($pro_profile->bus_registration, true);
                      $police_cer = json_decode($pro_profile->police_cer, true);
                      @endphp
                      <div class="ctnt">
                        Police Certificate
                        @if(isset($police_cer))
                    ...
                    <li>
                      ...
                      <div class="ctnt">
                        Late Fee
                        @if(isset($pro_profile->late_fee))
                        @if($pro_profile->late_fee == 1)
                        <span>Verified</span>
                        @endif
                        @else
                        <span>Pending</span>
                    ...
                    <li>
                      ...
                      <div class="ctnt">
                        Service insured 
                        @if($pro_profile->services_insured == 1)
                        <span>Verified</span>
                        @else
                        <span>Pending</span>
                        @endif
                    ...
                    <li>
                      ...
                      <div class="ctnt">
                        ...
                        @if($pro_profile->reimbursement == 1)
                        <span>Verified</span>
                        @else
                        <span>Pending</span>
                        @endif
                  ...
                  <div class="about_ctnt">
                    ...
                    <div class="gallery">
                      <div class="gallery_head">
                        <h5>Gallery <span class="badge"><?php echo count($decode_business_image)?></span></h5>
                      </div>
                      <div class="row">
                        @foreach($decode_business_image as $business_image_value)
                        <div class="col-md-4">
                          <div class="gallery_ctnt">
                            <figure style="background-image: url('{{asset('uploads/provider/'.$providerid.'/business/'.$business_image_value)}}');"></figure>
                          </div>
                        </div>
                        @endforeach
