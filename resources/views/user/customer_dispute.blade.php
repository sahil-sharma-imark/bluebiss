...
$provider_name = DB::table('users')->where('id',$provider_id)->select('name','lastname')->first();
@endphp
  <main id="main">
      ...
      <div class="container">
        <div class="dispute-box">
          ...
          <div class="dispute-form">
            <form method="POST" action="{{url('cus-dispute')}}">
              @csrf
              <div class="form-field">
                <label>Have you made an attempt to resolve the matter with<br> <b>{{$provider_name->name.' '.$provider_name->lastname}}</b>.</label>
