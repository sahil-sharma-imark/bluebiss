...
<main id="main" class="bg-color-gray">
    ...
    <section class="business-detail task-detail-sec">
      <div class="container">
        <form id="stepForm"  enctype="multipart/form-data" method="POST" action="{{url('edit-business-details/'.$user_business_detail->id)}}">
            @csrf
          <div class="main_wrap">
            ...
            <fieldset id="company_type">
              <div class="wrap_bg">
                ...
                <div class="check-box-radius">
                  <label>
                    <input type="radio" name="company_type" value="1" {{ ( $user_business_detail->company_type == 1) ? 'checked' : '' }}>
                    <span></span>
                    Sole Proprietor
                ...
                <div class="check-box-radius">
                  <label>
                    <input type="radio" name="company_type" value="2" {{ ( $user_business_detail->company_type == 2) ? 'checked' : '' }} >
                    <span></span>
                ...
                <div class="check-box-radius">
                  <label>
                    <input type="radio" name="company_type" value="3" {{ ( $user_business_detail->company_type == 3) ? 'checked' : '' }}>
                    <span></span>
                ...
                <div class="check-box-radius">
                  <label>
                    <input type="radio" name="company_type" value="4" {{ ( $user_business_detail->company_type == 4) ? 'checked' : '' }}>
                    <span></span>
                    Limited Liability
                ...
                <div class="check-box-radius">
                  <label>
                    <input type="radio" name="company_type" value="5" {{ ( $user_business_detail->company_type == 5) ? 'checked' : '' }}>
                    <span></span>
                    Other
              ...
              <div class="wrap_bg">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-field">
                      ...
                      <input type="text" class="form-control" name="business_name" id="business_name" value="{{$business_detail->business_name}}" placeholder="e.g. Jhon Doe Cleaning">
                  ...
                  <div class="col-md-6">
                    <div class="form-field">
                      ...
                      <input type="number" class="form-control" name="business_number" id="business_number" value="{{$business_detail->business_number}}" placeholder="e.g. 9876 543 210">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-field">
                      <label>Website (optional)</label>
                      <input type="text" class="form-control" name="business_website" id="business_website" value="{{$business_detail->business_website}}" placeholder="e.g. example.com">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-field">
                      <label>Business Email Address</label>
                      <input type="text" class="form-control" name="business_email" id="business_email" value="{{$business_detail->business_email}}" placeholder="e.g. example@mail.com">
                    </div>
                  </div>
                </div>
                <hr class="line">
                  ...
                  <div class="col-md-12">
                    <div class="form-field">
                      ...
                      <textarea class="form-control" name="description" id="description" 
                        placeholder="Enter a detailed description of what your business does and its experience">{{$business_detail->description}}</textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-field">
                      <label>Year Business Started</label>
                      <input type="text" class="form-control" name="business_date" id="business_date" value="{{$business_detail->business_date}}" placeholder="e.g. 2021">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-field">
                      <label>No of Employees</label>
                      <input type="text" class="form-control" name="n_employees" id="n_employees" value="{{$business_detail->n_employees}}" placeholder="No of Employees">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-field">
                      <label>Licence Number *</label>
                      <input type="text" class="form-control" name="licence_number" id="licence_number" value="{{$business_detail->licence_number}}" placeholder="e.g. 9876 5421 9875">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-field">
                      <label>Registration or ID Number *</label>
                      <input type="text" class="form-control" name="reg_id_number" id="reg_id_number" value="{{$business_detail->reg_id_number}}" placeholder="e.g. RID123545678">
                    </div>
                  </div>
                </div>
                <hr class="line">
                <div class="row">
                  <div class="form-field pre_hour">
                    ...
                    <div class="group">
                      ...
                      <input type="text" class="form-control" name="price_per_hour" id="price_per_hour" value="{{$business_detail->price_per_hour}}" placeholder="15.00">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="check-box-radius">
                      <label>
                        <input type="radio" name="hours" value="24 x 7" {{ ( $business_detail->hours == '24 x 7') ? 'checked' : '' }}>
                        <span></span>
                        Open 24 x 7
                      </label>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-field">
                      ...
                      <input type="text" class="form-control" name="probus_str_add" id="probus_str_add" value="{{$business_detail->loc_address}}"  placeholder="Street Address">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-field">
                      <label>Address Line 2</label>
                      <input type="text" class="form-control" name="probus_add_lin2" id="probus_add_lin2" value="{{$business_detail->loc_address2}}" placeholder="Address Line 2">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-field">
                      <label>City or Town *</label>
                      <input type="text" class="form-control" name="probus_city" id="probus_city" value="{{$business_detail->loc_city}}"  placeholder="City or Town" readonly>
                  ...
                  <div class="col-md-6">
                    <div class="form-field">
                      ...
                      <input type="text" class="form-control" name="probus_zip" id="probus_zip" value="{{$business_detail->loc_zip}}" placeholder="ZIP or Postcode" readonly>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-field">
                      <label>State or Province</label>
                      <input type="text" class="form-control" name="probus_state" id="probus_state" value="{{$business_detail->loc_state}}" placeholder="State or Province" readonly>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-field">
                      <label>Country *</label>
                      <input type="text" class="form-control" name="probus_country" id="probus_country" value="{{$business_detail->loc_country}}" placeholder="State or Province" readonly>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="map">
                    ...
                    <div class="form-field">
                      ...
                      <div class="late_check">
                        <div class="checkBox">
                          ...
                          <label for="Show">
                            <input type="checkbox" id="Show" name="reimbursement" value="1" {{ ( $business_detail->reimbursement == 1) ? 'checked' : '' }}><span></span>No - Show
                            Reimbursement</label>
                        </div>
                        <div class="checkBox">

                          <label for="Late">
                            <input type="checkbox" id="Late" name="late_fee" value="1" {{ ( $business_detail->late_fee == 1) ? 'checked' : '' }}><span></span>Late- Fee</label>
                        </div>
                        <div class="checkBox">
                          <label for="Money">
                            <input type="checkbox" id="Money" name="money_back" value="1" {{ ( $business_detail->money_back == 1) ? 'checked' : '' }}><span></span>Money Back</label>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-field">
                      ...
                      <div class="late_radio">
                        <div class="check-box-radius">
                          <label>
                            <input type="radio" name="services_insured" value="1" {{($business_detail->services_insured == 1) ? 'checked' : ''}}>
                            <span>Yes</span>
                          </label>
                        </div>
                        <div class="check-box-radius">
                          <label>
                            <input type="radio" name="services_insured" value="2" {{($business_detail->services_insured == 2) ? 'checked' : ''}}>
                            <span>No</span>
                          </label>
                        </div>
                      </div>
            ...
            <fieldset id="upload_images">
              <div class="wrap_bg">
                ...
                <div class="bnt-right">
                    ...
                    <button type="submit" name="next" class="btn next action-button-previous" value="">Update</button>             
                  </div>
              </div>
            </fieldset>
