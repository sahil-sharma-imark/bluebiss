              ...
              <div class="provider-listing-info">
                  <div class="provider-listing-info-top">
                    <div class="provider-listing-about-info">
                      <figure>
                        <img src="{{asset('uploads/provider/'.$all_s_detail->provider_id.'/'.$all_s_detail->provider_image)}}" alt="">
                      </figure>
  
                      <div class="provider-listing-about">
                        <h5 id="kdldl">{{$all_s_detail->provider_name.' '.$all_s_detail->provider_last}}
                    ...
                    <div class="right-view">
                      <div class="hou-price">${{$all_s_detail->provider_price}}/Hour</div>
                      <form method="POST" action="/send-request">
                        @csrf
                        <input type="hidden" name="cus_id">
                        <input type="hidden" name="prov_id">
                        <input type="hidden" name="req_title">
                        <input type="hidden" name="req_place">
                        <input type="hidden" name="req_date">
                        <input type="hidden" name="req_time">
                        <input type="hidden" name="prov_id">
                        <input type="hidden" name="req_amount">
                        <input type="hidden" name="req_desc">


                      <a class="btn send-request-bnt" href="{{url('task-details')}}"> <img src="images/send.svg" alt="">Send Request</a>
                      <!-- <button type="submit" class="btn">Submit</button> -->

                      <a class="btn view-profile-bnt" href="{{ url('provider-profile-preview/'.$all_s_detail->provider_id)}}">View Profile</a>
                      </form>
                    </div>
                  </div>

                  <h6>About Me :</h6>
                  <p>{{$all_s_detail->provider_des}}</p>
                  <p></p>
